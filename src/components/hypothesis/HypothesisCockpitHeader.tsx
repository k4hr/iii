...
export function HypothesisCockpitHeader({
  badges,
  breadcrumbs,
  createdAt,
  createdLabel,
  ...
  return (
    <header className="relative overflow-hidden rounded-[2rem] border border-cyan-100/[0.1] bg-[#020708]/92 p-5 shadow-[0_0_100px_rgba(24,215,203,.065)] sm:p-7">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_8%_0%,rgba(34,211,238,.16),transparent_34%),radial-gradient(circle_at_82%_20%,rgba(16,185,129,.1),transparent_32%),linear-gradient(135deg,rgba(10,42,46,.38),transparent_45%)]" />
      <div className="relative">
        ...
        <div className="grid gap-7 lg:grid-cols-[1fr_340px] lg:items-start">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-rose-300/15 bg-rose-300/[0.035] p-4">
              <div className="font-mono text-[9px] tracking-[.1em] text-rose-100/45 uppercase">{mainBlockerLabel}</div>
              <p className="mt-2 text-xs leading-5 text-rose-50/75">{mainBlocker || '—'}</p>
            </div>
          </div>
        </div>
      </div>
